...
namespace SQLBuilder.SQL.Builder {
    ...
    public class SelectQuery : BaseQuery {
        ...
        public SelectQuery(string Database, string Schema, string Table, string TableAlias) {
        ...
        /// <param name="Schema">The schema of the query.</param>
        /// <param name="Table">The table of the query.</param>
        public SelectQuery(string Database, string Schema, string Table)
        ...
        /// <returns>The current instance of this class.</returns>
        public SelectQuery SetTop(double Top, bool IsPercent, bool IsWithLies) {
            this._Top = Top;
            return this;
        }
        ...
        /// <param name="Top">The number of records.</param>
        /// <returns>The current instance of this class.</returns>
        public SelectQuery SetTop(double Top) {
        ...
        public SelectQuery SetSelect(string Expression) {
            return this.SetSelect(true, Expression);
        }
